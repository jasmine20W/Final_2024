...
The null hypothesis is rejected in favor the the alternative. The drug is effective in preventing the chances of getting covid-19 in drug users.
...
Above, is the effectiveness for the covid-19 for drug users, If the effectiveness is above 50% that means that the vaccine is effective. Based on the interval seen above, we can conclude that the vaccine is greatly effective in protecting drug users from getting covid-19. 

The hallmark of an effective vaccine is 60% or better. This vaccine does work great in protecting drug users from contracting covid-19.

The odds ratio is approximately how effective the vaccine is. The odds ratio for the drug users can be seen below 65. The effectiveness confidence interval for the drug users is 80.7 to 97.4.
